<template>
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <inertia-link :href="route('dashboard')" class="brand-link">
            <img :src="'/images/valorant.png'" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
            <span class="brand-text font-weight-light">VacciDash</span>
        </inertia-link>
